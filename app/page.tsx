export default function Page() {
  return (
    /* Outermost Page Wrapper: Fits the mobile screen viewport perfectly without cutting content */
    <div className="min-h-screen w-full flex flex-col justify-between p-6 md:grid md:grid-cols-2 md:gap-12 md:p-16 bg-black text-white box-border overflow-y-auto md:overflow-hidden">
      ...
      <div className="flex flex-col justify-center space-y-6 md:space-y-8 max-w-xl mx-auto md:mx-0">
        ...
        {/* --- Corporate Governance Matrix Text Block (Now fully optimized for mobile viewports!) --- */}
        <div className="border-t border-[#1a1a1a] pt-5 md:border-none md:pt-0 text-center md:text-left">
          ...
          {/* Metadata Badges */}
          <div className="flex justify-center md:justify-start gap-6 mt-4 text-[10px] uppercase tracking-wider border-b border-[#1a1a1a] pb-5 md:border-none md:pb-0">
            <div>
              <span className="text-neutral-500 block text-[8px] font-mono">Framework</span>
              <span className="text-white font-medium">Experience Architecture</span>
            </div>
            <div>
              <span className="text-neutral-500 block text-[8px] font-mono">Intellectual Property</span>
      ...
      <div className="w-full max-w-sm mx-auto flex flex-col justify-end pt-6 md:pt-0 md:justify-center mt-auto">
